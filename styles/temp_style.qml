  ...
  <elevation band="1" enabled="0" symbology="Line" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" name="" type="line" force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1">
        ...
        <layer id="{e6ba3113-951a-4135-8ae2-d9ae0dca43b7}" locked="0" pass="0" enabled="1" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" name="" type="fill" force_rhr="0" is_animated="0" frame_rate="10" clip_to_extent="1">
        ...
        <layer id="{a5f852e7-02ec-4f3e-b630-52a19a5c5a80}" locked="0" pass="0" enabled="1" class="SimpleFill">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer band="1" type="paletted" nodataColor="" alphaBand="-1" opacity="1">
      ...
      <colorPalette>
        ...
        <paletteEntry alpha="255" label="Decay" value="12" color="#4a3903"/>
        <paletteEntry alpha="255" label="Stubble" value="13" color="#acca16"/>
        <paletteEntry alpha="255" label="Winter cereals" value="14" color="#0de718"/>
        <paletteEntry alpha="255" label="Intermediate crops" value="15" color="#4fb284"/>
        <paletteEntry alpha="255" label="Intensive cultivated crops" value="16" color="#3ba12e"/>
        ...
        <paletteEntry alpha="255" label="Wetland" value="43" color="#066576"/>
        <paletteEntry alpha="255" label="Urban areas" value="51" color="#3ba12e"/>
        <paletteEntry alpha="255" label="Sand dune" value="61" color="#935d07"/>
